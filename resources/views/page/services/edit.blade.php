                    ...
                    <form action="services/edit/{{$list_services->id}}" method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="col-sm-12">Dịch vụ:
                                <input class="form-control" type="text" id="Name" name="txtName" style="width:80%" value="{{$list_services->name}}" pattern="[A-Z]{0,15}" title="Please enter capital letters or enter number."></div>

                            <div class="col-sm-12">Mô tả:
                                <input class="form-control" type="textarea" id="Desc" style="width:80%" name="txtDesc" value="{{$list_services->description}}"></div>
                        ...
                        <table class="table table-bordered table-hover" id="dataTable" width="100%">
                            ...
                            @if ($value->service_id == $list_services->id)
